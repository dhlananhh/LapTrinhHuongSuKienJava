...
public class DOMvsGUI extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (o.equals(btnAdd)) {
			...
			String country = JOptionPane.showInputDialog("Nhập vào quốc gia của nhà sản xuất: ");
			String website = JOptionPane.showInputDialog("Nhập vào website của nhà sản xuất: ");
			String price = JOptionPane.showInputDialog("Nhập vào đơn giá của sản phẩm: ");
			
			Supplier s = new Supplier(name, country, website);
